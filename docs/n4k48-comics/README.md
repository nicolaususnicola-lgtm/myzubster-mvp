...
**Stato NFT:** `CANDIDATE — RIGHTS REVIEW PENDING`. Prima di qualsiasi mint devono essere completati i controlli nel [registro di provenienza e diritti](PROVENANCE.md).
